...
const bloqueo: BloqueoAgenda = {
  ...
  zonaId: null,
  fechaHoraInicio: new Date('2026-07-01T08:00:00Z'),
  fechaHoraFin: new Date('2026-07-01T14:00:00Z'),
  motivo: 'Vacaciones',
  observacion: null,
  estado: 'ACTIVO',
...
describe('BloqueosAgendaService', () => {
  ...
  it('create guarda con estado ACTIVO por defecto', async () => {
    const dto = {
      ...
      fechaHoraInicio: '2026-07-01T08:00:00Z',
      fechaHoraFin: '2026-07-01T14:00:00Z',
      motivo: 'Test',
    };
    repository.create!.mockReturnValue({ ...dto, estado: 'ACTIVO' });
    repository.save!.mockResolvedValue(bloqueo);
    const result = await service.create(dto, 'u-1111');
