...
const reprog: ReprogramacionVisita = {
  ...
  horaProgramadaAnterior: '10:00:00',
  fechaProgramadaNueva: '2026-07-02',
  horaProgramadaNueva: '11:00:00',
  motivoReprogramacionId: null,
  observacion: 'Cambio de agenda',
  reprogramadaPorUsuarioId: 'u-1111',
  createdAt: new Date(),
};
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getRepositoryToken(ReprogramacionVisita),
          useValue: repository,
        },
        { provide: AuditoriasService, useValue: { registrar: jest.fn() } },
      ],
    }).compile();
    service = module.get<ReprogramacionesVisitaService>(
      ReprogramacionesVisitaService,
    );
  });
