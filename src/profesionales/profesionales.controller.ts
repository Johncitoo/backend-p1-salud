...
export class ProfesionalesController {
  ...
  findEspecialidades() {
    return this.service.findEspecialidades();
  }

  @Get('usuarios-disponibles')
  @Roles('ADMIN', 'COORDINADOR')
  findUsuariosDisponibles() {
    return this.service.findUsuariosDisponibles();
  }

  @Post('especialidades')
  @Roles('ADMIN', 'COORDINADOR')
  createEspecialidad(@Body() dto: CreateEspecialidadDto) {
    return this.service.createEspecialidad(dto);
  }
  ...
  updateEspecialidad(
    ...
    return this.service.updateEspecialidad(id, dto);
  }

  @Delete('especialidades/:id')
  @Roles('ADMIN')
  removeEspecialidad(@Param('id', ParseUUIDPipe) id: string) {
    return this.service.removeEspecialidad(id);
  }
  ...
  asignar(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: AsignarProfesionalDto,
  ) {
